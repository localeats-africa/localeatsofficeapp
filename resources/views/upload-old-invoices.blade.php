                                                ...
                                                <div class="card-body">
                                                      <div class="row mb-3">
                                                            ...
                                                            <div class="col-sm-12">
                                                                  ...
                                                                  <p></p>
                                                                  <small><i>Required column:</i>  <b>Total Amount, Total Payouts and Date</b></small>
                                                            </div>
                                                      </div>
                                                     
                                                      <div class="row mb-3">
                                                            <div class="col-sm-6">
                                                                  <form method="post" action="{{ route('past-invoices') }}" name="submit"  id=""  enctype="multipart/form-data">
                                                                  @csrf
                                                                  {{csrf_field()}}
