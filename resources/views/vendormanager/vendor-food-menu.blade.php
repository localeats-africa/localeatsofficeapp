...
<div class="main-panel">
      <div class="content-wrapper">
            <div class="page-header">
                  <h3 class="page-title">
                        <span class='text-info'> {{$vendorName}}</span> >>Food Menu
                  </h3>
                                                      ...
                                                      <td class="text-end">
                                                            <span class="dropdown">
                                                                  ...
                                                                  <div class="dropdown-menu text-center ">
                                                                        ...
                                                                        <form action="{{route('edit-food-menu', [$data->id])}}"
                                                                              ...
                                                                              <div class="input-group mb-2">
                                                                                    <input type="hidden"
                                                                                          ...
                                                                                          value="{{$data->id}}">
                                                                                    <button type="submit"
                                                                                          class="dropdown-item btn btn-sm text-capitalize text-dark">Edit!</button>
                                                                              </div>
                                                                        </form>
