                  ...
                  <div class="card">
                                    ...
                                    <table class="table table-striped card-table table-vcenter text-nowrap datatable"
                                          ...
                                          <tbody>
                                                ...
                                                <tr>
                                                      ...
                                                      <td class="text-capitalize">{{$data->area}}</td>
                              ...
                              <div class="card-footer d-flex align-items-center">
                                    <p class="m-0 text-secondary">
                                          ...
                                          Showing
                                          {{ ($location->currentPage() - 1) * $location->perPage() + 1; }} to
                                          {{ min($location->currentPage()* $location->perPage(), $location->total()) }}
                                          of
                                    ...
                                    <ul class="pagination m-0 ms-auto">
                                          @if(isset($location))
                                          @if($location->currentPage() > 1)
                                          <li class="page-item ">
                                                <a class="page-link text-danger"
                                                      href="{{ $location->previousPageUrl() }}" tabindex="-1"
                                                      aria-disabled="true">
                                          ...
                                          <li class="page-item">
                                                {{ $location->appends(compact('perPage'))->links()  }}
                                          </li>
                                          @if($location->hasMorePages())
                                          <li class="page-item">
                                                <a class="page-link text-danger" href="{{ $location->nextPageUrl() }}">
                                                      next
