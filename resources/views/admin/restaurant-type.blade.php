                  ...
                  <div class="col-12">
                        ...
                        <div class="alert  alert-success alert-dismissible" role="alert">
                              <div class="d-flex">
                                    ...
                                    <div> {!! session('add-restaurant') !!}</div>
                              </div>
            ...
            <form method="post" action="{{ route('add-restaurant') }}" name="submit" enctype="multipart/form-data">
                  ...
                  <div class="row">
                        <div class="col-md-4 grid-margin stretch-card">
                              <div class="card">
                                    <div class="card-body">
                                          <div class="form-label required">Type Of Restaurant <i
                                                      class="text-danger">*</i>
                                          </div>
                  ...
                  <div class="card">
                              ...
                              <div class="card-footer d-flex align-items-center">
                                    <p class="m-0 text-secondary">
                                          ...
                                          Showing
                                          {{ ($restaurant->currentPage() - 1) * $restaurant->perPage() + 1; }} to
                                          {{ min($restaurant->currentPage()* $restaurant->perPage(), $restaurant->total()) }}
                                          of
                                          {{$restaurant->total()}} entries
                                    </p>

                                    <ul class="pagination m-0 ms-auto">
                                          @if(isset($restaurant))
                                          @if($restaurant->currentPage() > 1)
                                          <li class="page-item ">
                                                <a class="page-link text-danger"
                                                      href="{{ $restaurant->previousPageUrl() }}" tabindex="-1"
                                                      aria-disabled="true">
                                          ...
                                          <li class="page-item">
                                                {{ $restaurant->appends(compact('perPage'))->links()  }}
                                          </li>
                                          @if($restaurant->hasMorePages())
                                          <li class="page-item">
                                                <a class="page-link text-danger" href="{{ $restaurant->nextPageUrl() }}">
                                                      next
